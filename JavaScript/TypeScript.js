...
var nameField = document.getElementById("nameField"), submitBtn = document.getElementById('submitBtn'), deleteBtn = document.getElementById('deleteBtn'), randomBtn = document.getElementById('randomBtn'), groupSizeBtn = document.getElementById('groupSizeBtn'), groupNumberBtn = document.getElementById('groupNumberBtn'), groupNumberField = document.getElementById('groupNumberField'), groupSizeField = document.getElementById('groupSizeField'), randomGroupsDisplay = document.getElementById('randomGroupsDisplay');
...
function populateListDisplay() {
    ...
    for (let i = 0; i < nameList.length; i++) {
        ...
        aTag.addEventListener('click', function (e) {
            for (let i = 0; i < nameList.length; i++) {
                if (nameList[i] === e.target.innerText) {
